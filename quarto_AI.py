    ...
    def _nextmove(self, state):
        ...
        if visible['pieceToPlay'] is not None:
            ...
            if 7 < x <= 9:
                ...
                quarto_algo_neg = Negamax(6, win_score=90,
                                          tt=TT)   # Algorithm(depth, scoring=None, win_score=inf,tt=None)
                Quarto = QuartoMind([AI_Player(quarto_algo_sss), AI_Player(quarto_algo_neg)], state)
                print(str(Quarto.get_move()))
                move = Quarto.get_move()    # find best move possible
...
# AI BOT1 => to play against AI (lvl4)
...
# AI BOT2 => to play against AI (lvl2)
    ...
    def _nextmove(self, state):
        ...
        if visible['pieceToPlay'] is not None:
            ...
            if x <= 13:
                ...
                quarto_algo_sss = Negamax(6, win_score=90,
                                          tt=TT)  # Algorithm(depth, scoring=None, win_score=inf,tt=None)
...
# AI BOT3 => to play against AI (lvl1)
class QuartoAIBOT3(game.GameClient):
    """Class representing a client for the Quarto game."""
...
# AI BOT4 => to play against AI (lvl3)
class QuartoAIBOT4(game.GameClient):
    """Class representing a client for the Quarto game."""
...
if __name__ == '__main__':
    ...
    elif args.component == 'BOT3':
        QuartoAIBOT3(args.name, (args.host, args.port), verbose=args.verbose)
    elif args.component == 'BOT4':
        QuartoAIBOT4(args.name, (args.host, args.port), verbose=args.verbose)
